...
#####################################################################
# 6½.  Install pre-made Powerlevel10k prompt  ───────────────────────
#####################################################################
STEP "Installing pre-configured Powerlevel10k prompt …"
cat > "$HOME/.p10k.zsh" <<"P10K"
# ────────────────────────────────────────────────────────────────────
#  ~/.p10k.zsh  – generated by Powerlevel10k wizard on 2025-08-06
#  (classic, light, nerdfont-v3, small icons, etc.)
#  >>>  EVERYTHING BELOW THIS LINE IS YOUR ORIGINAL CONFIG  <<<
# ────────────────────────────────────────────────────────────────────
# Generated by Powerlevel10k configuration wizard on 2025-08-06 at 11:53 UTC.
